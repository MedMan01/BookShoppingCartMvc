...
namespace BookShoppingCartMvcUI.Controllers
{
    ...
    {
        private readonly BookShoppingCartMvcUIContext _context;

        public BooksController(BookShoppingCartMvcUIContext context)
        {
            _context = context;
        }
        ...
        {
            var bookShoppingCartMvcUIContext = _context.Book.Include(b => b.Genre);
            return View(await bookShoppingCartMvcUIContext.ToListAsync());
        }
